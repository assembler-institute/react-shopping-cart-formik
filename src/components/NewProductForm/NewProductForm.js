				...
				>
					{({ handleChange, handleBlur, handleSubmit, errors, values, touched, isValidating, isValid }) => (
						<form onSubmit={handleSubmit}>
							...
							<Input type="text" label="Product img" id="img" value={values.img} placeholder="Product img" handleChange={handleChange} handleBlur={handleBlur} hasErrorMessage={touched.img} errorMessage={errors.img} />
							<Input type="text" label="Product short description" id="shortDescription" value={values.shortDescription} placeholder="Product short description" handleChange={handleChange} handleBlur={handleBlur} hasErrorMessage={touched.shortDescription} errorMessage={errors.shortDescription} />
							<Input type="text" label="Product long description" id="longDescription" value={values.longDescription} placeholder="Product long description" handleChange={handleChange} handleBlur={handleBlur} hasErrorMessage={touched.longDescription} errorMessage={errors.longDescription} />
							<Input type="number" label="Product stock" id="unitsInStock" value={values.unitsInStock} placeholder="Product stock" handleChange={handleChange} handleBlur={handleBlur} hasErrorMessage={touched.unitsInStock} errorMessage={errors.unitsInStock} />
